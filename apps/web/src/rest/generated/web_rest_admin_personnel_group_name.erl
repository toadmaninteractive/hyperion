...
-export([
    ...
    get_personnel_group_by_name_404/1,
    get_personnel_group_by_name_500/1
]).
...
get_personnel_group_by_name_404(ResponseContent404) ->
    throw(#{status_code => 404, response => ResponseContent404}).

get_personnel_group_by_name_500(ResponseContent500) ->
    throw(#{status_code => 500, response => ResponseContent500}).

handle_get(Req) ->
    try
        Name = cowboy_req:binding(name, Req),
        Response = web_rest_callback_admin_personnel_group:get_personnel_group_by_name(Name),
        Body = jsx:encode(protocol_db:personnel_group_to_json(Response)),
