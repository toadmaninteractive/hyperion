...
-export([
    ...
    set_personnel_account_role_404/1,
    set_personnel_account_role_500/1,
    reset_personnel_account_role_403/1,
    reset_personnel_account_role_404/1,
    reset_personnel_account_role_500/1
]).
...
set_personnel_account_role_404(ResponseContent404) ->
    throw(#{status_code => 404, response => ResponseContent404}).

set_personnel_account_role_500(ResponseContent500) ->
...
handle_put(Req) ->
    try
        ...
        Response = web_rest_callback_admin_personnel_roles:set_personnel_account_role(Request, Id, Project),
...
reset_personnel_account_role_404(ResponseContent404) ->
    throw(#{status_code => 404, response => ResponseContent404}).

reset_personnel_account_role_500(ResponseContent500) ->
    throw(#{status_code => 500, response => ResponseContent500}).
...
handle_delete(Req) ->
    try
        ...
        Response = web_rest_callback_admin_personnel_roles:reset_personnel_account_role(Id, Project),
        Body = jsx:encode(protocol_data:generic_response_to_json(Response)),
        ResponseHeaders = #{<<"Content-Type">> => <<"application/json; charset=utf-8">>},
