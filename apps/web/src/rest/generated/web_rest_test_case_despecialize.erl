...
-module(web_rest_test_case_despecialize).

-include_lib("igor/include/igor_http.hrl").

-export([
    init/2,
    despecialize_test_case_403/1,
    despecialize_test_case_404/1,
    despecialize_test_case_500/1
]).
...
despecialize_test_case_403(ResponseContent403) ->
    throw(#{status_code => 403, response => ResponseContent403}).

despecialize_test_case_404(ResponseContent404) ->
    throw(#{status_code => 404, response => ResponseContent404}).

despecialize_test_case_500(ResponseContent500) ->
...
handle_put(Req) ->
    try
        ...
        {ResponseContent, Req2} = web_rest_callback_test_case:despecialize_test_case(RequestContent, Id, SetupId, Req1),
