...
-module(web_rest_project_roles_account).

-include_lib("igor/include/igor_http.hrl").

-export([
    init/2,
    get_personnel_account_roles_for_project_403/1,
    get_personnel_account_roles_for_project_404/1,
    get_personnel_account_roles_for_project_500/1
]).
...
get_personnel_account_roles_for_project_403(ResponseContent403) ->
    throw(#{status_code => 403, response => ResponseContent403}).

get_personnel_account_roles_for_project_404(ResponseContent404) ->
    throw(#{status_code => 404, response => ResponseContent404}).

get_personnel_account_roles_for_project_500(ResponseContent500) ->
...
handle_get(Req) ->
    try
        ...
        OrderBy = igor_http:parse_query(<<"order_by">>, Qs, {custom, fun protocol_personnel:personnel_account_role_order_by_from_string/1}),
        ...
        Response = web_rest_callback_admin_personnel_roles:get_personnel_account_roles_for_project(Id, Needle, OrderBy, OrderDir, Offset, Limit),
        Body = jsx:encode(protocol_data:collection_slice_to_json(Response, {custom, fun protocol_db:personnel_account_role_to_json/1})),
