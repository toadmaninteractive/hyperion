...
-export([
    ...
    get_personnel_account_roles_404/1,
    get_personnel_account_roles_500/1
]).
...
get_personnel_account_roles_404(ResponseContent404) ->
    throw(#{status_code => 404, response => ResponseContent404}).

get_personnel_account_roles_500(ResponseContent500) ->
...
handle_get(Req) ->
    try
        ...
        Response = web_rest_callback_admin_personnel_roles:get_personnel_account_roles(Id, Needle, OrderBy, OrderDir, Offset, Limit),
