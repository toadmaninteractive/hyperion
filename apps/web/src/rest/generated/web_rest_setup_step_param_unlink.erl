...
-module(web_rest_setup_step_param_unlink).

-include_lib("igor/include/igor_http.hrl").

-export([
    init/2,
    unlink_setup_step_from_parameter_403/1,
    unlink_setup_step_from_parameter_404/1,
    unlink_setup_step_from_parameter_500/1
]).
...
unlink_setup_step_from_parameter_403(ResponseContent403) ->
    throw(#{status_code => 403, response => ResponseContent403}).

unlink_setup_step_from_parameter_404(ResponseContent404) ->
    throw(#{status_code => 404, response => ResponseContent404}).

unlink_setup_step_from_parameter_500(ResponseContent500) ->
...
handle_put(Req) ->
    try
        ...
        {ResponseContent, Req2} = web_rest_callback_setup:unlink_setup_step_from_parameter(RequestContent, Id, Req1),
