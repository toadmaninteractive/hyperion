...
-module(web_rest_test_run_item_fail).

-include_lib("igor/include/igor_http.hrl").

-export([
    init/2,
    fail_test_run_item_400/1,
    fail_test_run_item_403/1,
    fail_test_run_item_404/1,
    fail_test_run_item_500/1
]).
...
fail_test_run_item_400(ResponseContent400) ->
    throw(#{status_code => 400, response => ResponseContent400}).

fail_test_run_item_403(ResponseContent403) ->
    throw(#{status_code => 403, response => ResponseContent403}).

fail_test_run_item_404(ResponseContent404) ->
    throw(#{status_code => 404, response => ResponseContent404}).

fail_test_run_item_500(ResponseContent500) ->
...
handle_put(Req) ->
    try
        ...
        {ResponseContent, Req2} = web_rest_callback_test_run_item:fail_test_run_item(RequestContent, Id, Req1),
