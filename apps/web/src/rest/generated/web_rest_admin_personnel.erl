...
-export([
    ...
    get_personnel_account_404/1,
    get_personnel_account_500/1
]).
...
get_personnel_account_404(ResponseContent404) ->
    throw(#{status_code => 404, response => ResponseContent404}).

get_personnel_account_500(ResponseContent500) ->
    throw(#{status_code => 500, response => ResponseContent500}).

handle_get(Req) ->
    try
        Id = igor_http:parse_value(cowboy_req:binding(id, Req), long),
        Response = web_rest_callback_admin_personnel:get_personnel_account(Id),
