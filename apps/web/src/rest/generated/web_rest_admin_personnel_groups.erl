...
-export([
    ...
    get_personnel_groups_404/1,
    get_personnel_groups_500/1
]).
...
get_personnel_groups_404(ResponseContent404) ->
    throw(#{status_code => 404, response => ResponseContent404}).

get_personnel_groups_500(ResponseContent500) ->
...
handle_get(Req) ->
    try
        ...
        OrderBy = igor_http:parse_query(<<"order_by">>, Qs, {custom, fun protocol_personnel:personnel_group_order_by_from_string/1}),
        ...
        Response = web_rest_callback_admin_personnel_group:get_personnel_groups(Needle, OrderBy, OrderDir, Offset, Limit),
        Body = jsx:encode(protocol_data:collection_slice_to_json(Response, {custom, fun protocol_db:personnel_group_to_json/1})),
