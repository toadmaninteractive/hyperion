...
handle_get(Req) ->
    try
        ...
        Body = jsx:encode(protocol_settings:settings_to_json(Response)),
...
handle_put(Req) ->
    try
        ...
        Request = protocol_settings:settings_update_request_from_json(jsx:decode(RequestBody, [return_maps])),
