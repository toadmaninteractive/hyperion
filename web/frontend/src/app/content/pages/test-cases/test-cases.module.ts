...
import { TestCasesOverviewComponent } from './test-cases-overview/test-cases-overview.component';
...
@NgModule({
    imports: [
        ...
        RouterModule.forChild([
            {
                path: '**',
                component: TestCasesOverviewComponent,
                resolve: {
    ...
    exports: [
        BrowseSetupDialogComponent,
    ],
    providers: [],
    declarations: [
        BrowseSetupDialogComponent,
        TestCasesOverviewComponent,
    ],
    entryComponents: [
        BrowseSetupDialogComponent,
    ]
